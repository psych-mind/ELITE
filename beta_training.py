...
entity_1, rel_1, triples_1, time_int_1, time_1 =\
      load_triples('/home/jiayun/Desktop/ELITE/dataset/BETA/triples_1')
entity_2, rel_2, triples_2, time_int_2, time_2 = \
load_triples('/home/jiayun/Desktop/ELITE/dataset/BETA/triples_2')
...
for j, snap_shot in enumerate(snap_shots):
    ...
    if j == 0:
        ...
        #print(dev_pair_select[:5], len(dev_pair_select))
        #dev_pair_list.append(dev_pair_select)

        _, _, triples_1t, _, _ =\
        load_triples(file_path + f'BETA/{snap_shot[:-1]}/triples_1')

        _, _, triples_n, _, _ = \
            load_triples(file_path + 'BETA/triples_1n')
        ...
        index_r, thres_r = gen_threshold(score_r, 10)
        index_t, thres_t = gen_threshold(score_t, 10)
